...
OutPut:
    Enter the First sequence::ADCNSRLCRPM
Enter the Second sequence::ASCANRKCRDP
...
['A', 'S', 'C', 'A', 'N', 'R', 'K', 'C', 'R', 'D', 'P']
[['S', 'N', 'C'], ['D', 'R']]
similarity of the Sequences:: 1
identity of the Sequences:: 5
Gap in the sequence 0
Pergetage of sequence are:: 54.54545454545454 %
